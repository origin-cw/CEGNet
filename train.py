...
from models import model as pose_net
...
parser.add_argument('--loss_type', type=str, default= "ADD",  help='trianing loss:ADD')

parser.add_argument('--dataset', type=str, default='tless', help='tless')
...
parser.add_argument('--decay_epoch', default=31, help='learning rate decay rate')  
...
def main():
    ...
    if opt.dataset == 'tless':
        ...
        opt.outf = 'experiments/tless/{}/{}/model/'.format(opt.loss_type, opt.experiment)  
        opt.log_dir = 'experiments/tless/{}/{}/log/'.format(opt.loss_type, opt.experiment)  
...
def test(test_loader, estimator, lossor, epoch, tensorboard_writer, tensorboard_test_list, opt):
    ...
    with torch.no_grad():  
        ...
        for data in test_loader:
            ...
            total_eval_rt_list += instance_eval_rt_list
        ...
        save_pred_and_gt_json(total_eval_rt_list, total_instance_list, total_gt_list, total_cls_list,total_rt_list ,opt.log_dir)   
